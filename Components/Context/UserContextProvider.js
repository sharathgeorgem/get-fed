...
class UserContextProvider extends React.Component {
  ...
  setPosition = position => {
    ...
    this.setState(
      ...
      () => fetch(`https://www.mapquestapi.com/geocoding/v1/reverse?key=${config.mapquestKey}&location=${this.state.userLocation.coords.latitude},${this.state.userLocation.coords.longitude}&includeRoadMetadata=true&includeNearestIntersection=true`)
        .then(res => res.json())
        .then(response => {
