...
class Cart extends React.Component {
  componentDidMount () {
    fetch(`${this.props.userContext.domain}/user/cart/${this.props.userContext.userId}`)
    .then(res => res.json())
    .then(this.props.cartContext.updateCart)
  }
  addItem = itemType => {
    console.log('added item is', itemType.item.id)
    fetch(`${this.props.userContext.domain}/user/cart/${this.props.userContext.userId}/${itemType.item.id}`, {
      method: 'PUT'
    })
    .then(res => res.json())
    .then(this.props.cartContext.updateCart)
